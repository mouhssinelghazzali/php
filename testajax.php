<?php 
    ...
    // Fetch all the type data 
    
    $type=isset($_POST['type'])?$_POST['type']:"is_axe";
    $query="SELECT distinct s_theme FROM said_datamap WHERE ".$type."=1";
 ...
 <body>
  ...
  <div class="container" style="width:600px;">
   ...
   <form method="post" id="insert_data">
    ...
    <option value="is_axe" selected>Axe</option>
  <option value="is_gare">Gare</option> 
  <option value="is_ligne">Ligne</option> 
    </select>
