...
$sqlcritere = "SELECT libelle, crit_fille, variable, chartsingle FROM t_critere WHERE crit_fille IS NOT NULL AND variable IS NOT NULL ORDER BY crit_fille, ordre";
...
if($_SESSION['type']<4)
{
	...
	{
?>
<fieldset><legend>Entité</legend>
<form action="index.php?id=3" method="get">
<input type="hidden" name="id" value="3" />
<select name="identite" onchange="this.form.submit();">
  <option value="<?php if( $_SESSION['identite']=="national") {echo "national";}else{echo $_SESSION['identite'];}?>">Sélectionner une entité</option>
  <?php
...
<fieldset><legend>Axes / Gares</legend>
<select name="axe" onchange="Axer(this.value);Recharger();">
<option>Sélectionner un axe</option>
<?php
	$sqlaxe = "SELECT id_axes, lib_axes FROM t_axes INNER JOIN t_user ON t_user.identite=t_axes.id_possesseur WHERE t_axes.id_possesseur = '".$identite."' GROUP BY lib_axes";
...
<?php
$sqlgroup="SELECT libelle, crit_mere, chartsingle FROM t_critere WHERE ordre<10 ORDER BY ordre";
...
while($listegroup = $requetegroup->fetch())
{
	...
	if(!empty($textitems_options))//if(($affichess_item) && (empty($listegroup['chartsingle'])))
		{
...
function Recharger()
{
	...
	if(theme1[theme] != undefined)
	{
		...
		data1 = JSON.parse(file("trouver_libelle.php?single="+variable1[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence));
		var subcaption1 = file("trouver_libelle.php?effectif="+variable1[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence);
	...
	if(theme2[theme] != undefined)
	{
		...
		data2 = JSON.parse(file("trouver_libelle.php?single="+variable2[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence));
		var subcaption2 = file("trouver_libelle.php?effectif="+variable2[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence);
	...
	if(theme3[theme] != undefined)
	{
		...
		data3 = JSON.parse(file("trouver_libelle.php?single="+variable3[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence));
		var subcaption3 = file("trouver_libelle.php?effectif="+variable3[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence);
	...
	if(theme4[theme] != undefined)
	{
		...
		data4 = JSON.parse(file("trouver_libelle.php?single="+variable4[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence));
		var subcaption4 = file("trouver_libelle.php?effectif="+variable4[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence);
	...
	if(theme5[theme] != undefined)
	{
		...
		data5 = JSON.parse(file("trouver_libelle.php?single="+variable5[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence));
		var subcaption5 = file("trouver_libelle.php?effectif="+variable5[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence);
	...
	if(theme6[theme] != undefined)
	{
		...
		data6 = JSON.parse(file("trouver_libelle.php?single="+variable6[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence));
		var subcaption6 = file("trouver_libelle.php?effectif="+variable6[theme]+"&vague="+vague+"&axe="+axe+"&frequence="+frequence);
